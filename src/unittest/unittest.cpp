...
TEST_F(SingleLineInput, BackspaceIntoLeftMarginWithScroll) {
  ...
  EXPECT_STREQ(output_.c_str(),
    ...
    L"[SLINPUT_CCC_DISABLE_CURSOR][SLINPUT_CCC_CLEAR_LINE]>  hree [SLINPUT_CCC_SAVE_CURSOR]four five  [SLINPUT_CCC_RESTORE_CURSOR][SLINPUT_CCC_ENABLE_CURSOR]"
    L"[SLINPUT_CCC_DISABLE_CURSOR][SLINPUT_CCC_CLEAR_LINE]>   two [SLINPUT_CCC_SAVE_CURSOR]three four [SLINPUT_CCC_RESTORE_CURSOR][SLINPUT_CCC_ENABLE_CURSOR]"
    /* Backspaces (requiring full line redraw) */
    ...
    /* Backspaces (beyond cursor margin with \b and redraw to end of line)*/
    L"\b[SLINPUT_CCC_DISABLE_CURSOR][SLINPUT_CCC_CLEAR_TO_END_OF_LINE][SLINPUT_CCC_SAVE_CURSOR]three four  [SLINPUT_CCC_RESTORE_CURSOR][SLINPUT_CCC_ENABLE_CURSOR]"
    L"\b[SLINPUT_CCC_DISABLE_CURSOR][SLINPUT_CCC_CLEAR_TO_END_OF_LINE][SLINPUT_CCC_SAVE_CURSOR]three four f [SLINPUT_CCC_RESTORE_CURSOR][SLINPUT_CCC_ENABLE_CURSOR]"
    L"\b[SLINPUT_CCC_DISABLE_CURSOR][SLINPUT_CCC_CLEAR_TO_END_OF_LINE][SLINPUT_CCC_SAVE_CURSOR]three four fi [SLINPUT_CCC_RESTORE_CURSOR][SLINPUT_CCC_ENABLE_CURSOR]"
    L"\b[SLINPUT_CCC_DISABLE_CURSOR][SLINPUT_CCC_CLEAR_TO_END_OF_LINE][SLINPUT_CCC_SAVE_CURSOR]three four fiv [SLINPUT_CCC_RESTORE_CURSOR][SLINPUT_CCC_ENABLE_CURSOR]"
    L"\b[SLINPUT_CCC_DISABLE_CURSOR][SLINPUT_CCC_CLEAR_TO_END_OF_LINE][SLINPUT_CCC_SAVE_CURSOR]three four five [SLINPUT_CCC_RESTORE_CURSOR][SLINPUT_CCC_ENABLE_CURSOR]"
    /* New line */
    L"\n"
    /* Line wrap on */
    L"[SLINPUT_CCC_WRAP_ON]"
...
TEST_F(SingleLineInput, DeletionAndBackspaceAtMiddleWithScroll) {
  ...
  EXPECT_STREQ(output_.c_str(),
    ...
    L"[SLINPUT_CCC_DISABLE_CURSOR][SLINPUT_CCC_CLEAR_TO_END_OF_LINE][SLINPUT_CCC_SAVE_CURSOR]four five  [SLINPUT_CCC_RESTORE_CURSOR][SLINPUT_CCC_ENABLE_CURSOR]"
    /* Backspace to remove two (requiring full line redraw) */
    ...
    /* Backspace to remove two (beyond cursor margin with \b and redraw to end of line) */
    L"\b[SLINPUT_CCC_DISABLE_CURSOR][SLINPUT_CCC_CLEAR_TO_END_OF_LINE][SLINPUT_CCC_SAVE_CURSOR]four five s [SLINPUT_CCC_RESTORE_CURSOR][SLINPUT_CCC_ENABLE_CURSOR]"
    /* Key presses */
