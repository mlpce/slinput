...
TEST_F(SingleLineInput, InsertToScrollZeroMarginThenWarpAndHome) {
  SLINPUT_Stream stream = { this };
  SLINPUT_AllocInfo alloc_info = { this };
  SLINPUT_State *state =
    SLINPUT_CreateState(alloc_info, MallocIn, FreeIn);
  ...
  EXPECT_STREQ(output_.c_str(),
    ...
    L"[SLINPUT_CCC_DISABLE_CURSOR][SLINPUT_CCC_CLEAR_LINE]>  hree four five [SLINPUT_CCC_SAVE_CURSOR] [SLINPUT_CCC_RESTORE_CURSOR][SLINPUT_CCC_ENABLE_CURSOR][SLINPUT_CCC_DISABLE_CURSOR][SLINPUT_CCC_CLEAR_LINE]>  e four five six[SLINPUT_CCC_SAVE_CURSOR] [SLINPUT_CCC_RESTORE_CURSOR][SLINPUT_CCC_ENABLE_CURSOR]"
    /* New line */
    L"\n"
    /* Line wrap on */
    L"[SLINPUT_CCC_WRAP_ON]");
